...
public class RecipeLibraryTest {
    ...
    public void testIterator() {
        ...
        Assertions.assertTrue(recipeLibrary.iterator().hasNext(), "The RecipeLibrary should have a next recipe");
        Assertions.assertEquals(r1, recipeLibrary.iterator().next(), "The next recipe from the iterator should be r1");
    }
